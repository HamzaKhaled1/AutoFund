...
const Circle=({text,img,id})=>{
    ...
    style={{backgroundImage:`url('${img}')`}} onClick={handleClick}>
        ...
        <p className={` font-bold text-white bg-black/50  text-xs  sm:text-xl  flex text-center justify-center ${flag?"text-lg p-2 absolute bottom-0 rounded-none":"text-2xl p-2 rounded-3xl"}`}>
                {flag?data.text:text}
        </p>
