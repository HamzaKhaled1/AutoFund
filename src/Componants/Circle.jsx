...
const Circle=({text,img,id})=>{
    ...
    return(<> 
    <div className={`sm:h-72  sm:w-72 flex h-40 w-40  justify-center mt-20 items-center  relative border-2 border-black bg-cover transition-transform to-sky-300 hover:scale-105 duration-300 cursor-pointer ease-in-out ${flag?"rounded-xl h-64 w-64 sm:h-72 sm:w-72":"rounded-full"} `}
